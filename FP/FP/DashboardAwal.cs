...
namespace FP
{
    public class DashboardAwal
    {
        ...
        public static LinkedlistMotor.Garasi garasi = new LinkedlistMotor.Garasi();
        public static LinkedlistMotorTersewa.Tersewa tersewa = new LinkedlistMotorTersewa.Tersewa();
        public static DashboardAdmin da = new DashboardAdmin(akun, garasi, tersewa);
